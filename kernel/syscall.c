...
extern uint64 sys_force_fail(void);
extern uint64 sys_get_force_fail(void);
extern uint64 sys_raw_read(void);
extern uint64 sys_get_disk_lbn(void);
extern uint64 sys_raw_write(void);
